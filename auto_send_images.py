...
import os
from auto_config import MS_NAME, IMG_TAG, IMG_SERVICES, REMOTE_TARGET_DIR, SOURCE_DIR, REMOTE_SERVER

print("Sending images to "+ REMOTE_SERVER +"...")
os.system("scp ./"+ SOURCE_DIR +" "+ REMOTE_SERVER +":"+ REMOTE_TARGET_DIR)
print("Done!")
